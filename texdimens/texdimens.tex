...
% upon it. And computation of Zu and Zd was based upon getting R first.
%
% A worked-out alternative to current package approach (2021/11/07)
% -----------------------------------------------------------------
%
...
% does not help. Actually for all core units with phi>2 it is found
% computationally out that
% round((\maxdimen+0.5)psi)=round(\maxdimen psi)
% so choosing the R or X approaches has no impact on the potential
