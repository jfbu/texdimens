...
% now we have X;a;T;
% if X>T, our candidate "a=#2" must be decreased by 1.
% Else we
% check if X sp is expressible in bp unit. If yes we are done, if not
% we decrease "a" by 1. The check could be done by computing X modulo 803
