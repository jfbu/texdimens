...
\def\texdimendown_neg#1#2-#3;#4;#5;%
   {#1\expandafter\texdiminpt_\the\dimexpr-\texdimendown_b#3;#4;#5;pt\relax}%
%
% pt
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminbpdown_d#1PT};#2;#3;%
   {\ifdim#1bp>#3sp \texdimendown_e{#2}\fi\texdimenfirstofone{#1}}%
}%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminbpup_d#1PT};#2;#3;%
   {\ifdim#1bp<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
% nd 685/642
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminnddown_d#1PT};#2;#3;%
   {\ifdim#1nd>#3sp \texdimendown_e{#2}\fi\texdimenfirstofone{#1}}%
}%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminndup_d#1PT};#2;#3;%
   {\ifdim#1nd<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
% dd 1238/1157
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdimindddown_d#1PT};#2;#3;%
   {\ifdim#1dd>#3sp \texdimendown_e{#2}\fi\texdimenfirstofone{#1}}%
}%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminddup_d#1PT};#2;#3;%
   {\ifdim#1dd<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminmmup_d#1PT};#2;#3;%
   {\ifdim#1mm<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
% pc 12/1
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminpcup_d#1PT};#2;#3;%
   {\ifdim#1pc<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
% nc 1370/107
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminncup_d#1PT};#2;#3;%
   {\ifdim#1nc<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
% cc 14856/1157
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdiminccup_d#1PT};#2;#3;%
   {\ifdim#1cc<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
% cm 7227/254
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdimincmup_d#1PT};#2;#3;%
   {\ifdim#1cm<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
% in 7227/100
%
...
{\catcode`P 12\catcode`T 12\lowercase{\gdef\texdimininup_d#1PT};#2;#3;%
   {\ifdim#1in<#3sp \texdimenup_e{#2}\fi\texdimenfirstofone{#1}}%
}%
%
\texdimensendinput
%! Local variables:
