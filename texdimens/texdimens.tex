...
\def\texdiminbpup_a#1{\if-#1\texdimenup_neg\fi\texdiminbpup_b#1}%
...
\def\texdiminndup_a#1{\if-#1\texdimenup_neg\fi\texdiminndup_b#1}%
...
\def\texdiminddup_a#1{\if-#1\texdimenup_neg\fi\texdiminddup_b#1}%
