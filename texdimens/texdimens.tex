...
\def\texdimenboth_a#1{\texdimengobtilminus#1\texdimenboth_neg-\texdimenboth_b#1}%
...
% in front of the \numexpr.
\def\texdimenboth_neg-\texdimenboth_b-#1;#2;{%
    -\numexpr(((2*#1-3612)/7227)*#2sp\relax
}%
%
...
\def\texdimenbothsp_a#1{\texdimengobtilminus#1\texdimenbothsp_neg-\texdimenbothsp_b#1}%
...
\def\texdimenbothsp_neg-\texdimenbothsp_b-#1;{%
    -\numexpr(((2*#1-3612)/7227)*7227+1)/2-1\relax\relax
}%
%
