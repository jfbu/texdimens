...
% (see the project repository), and we could actually combine them into
% a generic one handling general a/b (verifying the above
% condition). But for the the sake of efficiency, this is "rolled-out"
% here unit per unit.
%
