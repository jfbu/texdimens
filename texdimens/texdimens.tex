...
% ===========================================
%
% uu = core TeX unit (not sp, and no down/up for pt)
%
% added (\texdimenuu): initial release
% added (\texdimenuudown, \texdimenuuup): 0.9gamma
% modified: 1.0
% modified: 1.1 (micro coding improvements)
%
% Mathematics
% -----------
%
...
%
% Overcoming the ceil() stumbling block
% ------------------------------------- 
%
...
%
% "up and down macros" (1.0 version)
%
...
%
% added:    0.99
% modified: 1.0 (new output for second argument < 1pt)
% modified: 1.1 (new algorithm for second arg < 1pt)
%
% Mathematics
% -----------
%
...
% (hence we drop f-expandability which would be ensured by \the\numexpr k+...).
...
% (indeed, very little usage of \ifnum in xint, so no need to test that in
% the past). We will use this for time being. I felt computing #1/4 only
% but adding an extra step would cost, but I have not tested.
