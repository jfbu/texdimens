...
% "up" and "down" were done at 0.9 gamma release is a bit costly.
%
...
%
% Overcoming the ceil() stumbling block (1.0 release)
% ---------------------------------------------------
%
...
% below for all obtained formulae.
%
% Implementation
% ==============
%
...
% ===================================================================
% The notation <u/v> is used for u/v in numexpr, which does rounding
% away from zero. It is essential that the argument be >-0.5 else <x+1>
% not same as <x>+1. All formulae are overflow free. The comments are
% for T > 0. Roughly such an approch works for conversion factors a/b,
% a>b such that a*(2b+1)<2**31 if a is odd, <2**32 if a is even.
% This is true for all core units with quite some margin, the worst
% being phi=7227/2540 for "mm".
%
...
\def\texdimenbpdown_d#1;#2;{\numexpr800*#2+800-(1284003-1600*#1)/1606sp}%
...
\def\texdimenbpup_d#1;#2;{\numexpr800*#2+801-(1285603-1600*#1)/1606sp}%
% nd 685/642
% T = 685 k + r
...
\def\texdimennddown_d#1;#2;{\numexpr642*#2+642-(878941-1284*#1)/1370sp}%
...
\def\texdimenndup_d#1;#2;{\numexpr642*#2+643-(880225-1284*#1)/1370sp}%
% dd 1238/1157
% T = 1238 k + r
...
\def\texdimendddown_d#1;#2;{\numexpr1157*#2+1157-(1431828-1157*#1)/1238sp}%
...
\def\texdimenddup_d#1;#2;{\numexpr1157*#2+1158-(1432985-1157*#1)/1238sp}%
% mm 7227/2540
% T = 7227 k + r
...
\def\texdimenmmdown_d#1;#2;{\numexpr2540*#2+2540-(36715307-5080*#1)/14454sp}%
...
\def\texdimenmmup_d#1;#2;{\numexpr2540*#2+2541-(36720387-5080*#1)/14454sp}%
% pc 12/1
% T = 12 k + r
% Zd = 1 k + 1 - <(17 - 1 r)/12>
...
\def\texdimenncdown_d#1;#2;{\numexpr107*#2+107-(147168-107*#1)/1370sp}%
...
\def\texdimenncup_d#1;#2;{\numexpr107*#2+108-(147275-107*#1)/1370sp}%
% cc 14856/1157
% T = 14856 k + r
...
\def\texdimenccdown_d#1;#2;{\numexpr1157*#2+1157-(17194663-1157*#1)/14856sp}%
...
\def\texdimenccup_d#1;#2;{\numexpr1157*#2+1158-(17195820-1157*#1)/14856sp}%
% cm 7227/254
% T = 7227 k + r
...
\def\texdimencmdown_d#1;#2;{\numexpr254*#2+254-(3678035-508*#1)/14454sp}%
...
\def\texdimencmup_d#1;#2;{\numexpr254*#2+255-(3678543-508*#1)/14454sp}%
% in 7227/100
% T = 7227 k + r
...
\def\texdimenindown_d#1;#2;{\numexpr#200+100-(1452427-2*#100)/14454sp}%
...
\def\texdimeninup_d#1;#2;{\numexpr#200+101-(1452627-2*#100)/14454sp}%
% both in and cm
