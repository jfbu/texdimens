...
% as it meant adding one extra pair of parentheses to incm and cmin for incmpt
\def\texdimenbothincm#1{\expandafter\texdimenstrippt\the\dimexpr
    \expandafter\texdimenboth_a
    \the\numexpr\dimexpr#1\relax\relax-3612)/7227)*127)sp\relax}%
\def\texdimenbothcmin#1{\expandafter\texdimenstrippt\the\dimexpr
    \expandafter\texdimenboth_a
    \the\numexpr\dimexpr#1\relax\relax-3612)/7227)*50)sp\relax}%
\def\texdimenbothincmpt#1{\expandafter\texdimenstrippt\the\dimexpr
    \expandafter\texdimenboth_a
    \the\numexpr\dimexpr#1\relax\relax-3612)/7227)*7227+1)/2-1sp\relax}%
