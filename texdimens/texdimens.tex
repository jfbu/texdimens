...
%          to a decimal 0.dddddd or 1.0 of "ceil(r * 65536/f) sp"
%          (which is at most 65536sp=1pt so E is at most 1.0).
%
%          To compute the Euclidean quotient k in \numexpr we use there
%          (2T-f)/(2f) i.e. round((2T-f)/2f) which is same as trunc(T/f)
...
%
%          The problem is: how to get the sign of R*f-65536*r without
%          overflow? I considered various ways.
%
%          But in the end, opted for simply this:
%          - get R=round(r*65536/f) as r*65536/f in numexpr
