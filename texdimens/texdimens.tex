...
\def\texdimenbothincm#1{\expandafter\texdimenboth_a\the\numexpr\dimexpr#1;127);}%
\def\texdimenbothcmin#1{\expandafter\texdimenboth_a\the\numexpr\dimexpr#1;50);}%
\def\texdimenbothincmpt#1{\expandafter\texdimenboth_a\the\numexpr\dimexpr#1;7227+1)/2-1;}%
...
\def\texdimenboth_neg#1#2-#3;#4;{#1\expandafter\texdimenstrippt\the\dimexpr-#2#3;#4;pt\relax}%
%
