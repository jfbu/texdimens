...
% we premultiplied the first argument by 2... must be undone now! what a waste.
\def\texdimenwithunit_p@#1#2;#3;{\expandafter\texdimenstrippt\the\dimexpr#1#3sp/2\relax}%
