...
\def\texdimenbpdown_d#1;#2;{\numexpr800*(#2+1)-(1284003-1600*#1)/1606sp}%
...
\def\texdimenbpup_d#1;#2;{\numexpr800*(#2+1)+1-(1285603-1600*#1)/1606sp}%
% nd 685/642
% T = 685 k + r
...
\def\texdimennddown_d#1;#2;{\numexpr642*(#2+1)-(878941-1284*#1)/1370sp}%
...
\def\texdimenndup_d#1;#2;{\numexpr642*(#2+1)+1-(880225-1284*#1)/1370sp}%
% dd 1238/1157
% T = 1238 k + r
...
\def\texdimendddown_d#1;#2;{\numexpr1157*(#2+1)-(1431828-1157*#1)/1238sp}%
...
\def\texdimenddup_d#1;#2;{\numexpr1157*(#2+1)+1-(1432985-1157*#1)/1238sp}%
% mm 7227/2540
% T = 7227 k + r
...
\def\texdimenmmdown_d#1;#2;{\numexpr2540*(#2+1)-(36715307-5080*#1)/14454sp}%
...
\def\texdimenmmup_d#1;#2;{\numexpr2540*(#2+1)+1-(36720387-5080*#1)/14454sp}%
% pc 12/1
% T = 12 k + r
% Zd = 1 k + 1 - <(17 - 1 r)/12>
...
\def\texdimenncdown_d#1;#2;{\numexpr107*(#2+1)-(147168-107*#1)/1370sp}%
...
\def\texdimenncup_d#1;#2;{\numexpr107*(#2+1)+1-(147275-107*#1)/1370sp}%
% cc 14856/1157
% T = 14856 k + r
...
\def\texdimenccdown_d#1;#2;{\numexpr1157*(#2+1)-(17194663-1157*#1)/14856sp}%
...
\def\texdimenccup_d#1;#2;{\numexpr1157*(#2+1)+1-(17195820-1157*#1)/14856sp}%
% cm 7227/254
% T = 7227 k + r
...
\def\texdimencmdown_d#1;#2;{\numexpr254*(#2+1)-(3678035-508*#1)/14454sp}%
...
\def\texdimencmup_d#1;#2;{\numexpr254*(#2+1)+1-(3678543-508*#1)/14454sp}%
% in 7227/100
% T = 7227 k + r
...
\def\texdimenindown_d#1;#2;{\numexpr100*(#2+1)-(1452427-200*#1)/14454sp}%
...
\def\texdimeninup_d#1;#2;{\numexpr100*(#2+1)+1-(1452627-200*#1)/14454sp}%
% both in and cm
